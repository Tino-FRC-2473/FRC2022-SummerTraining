...
public final class HardwareMap {
	...
	public static final int CAN_ID_SPARK_DRIVE_FRONT_RIGHT = 0;
	//public static final int CAN_ID_SPARK_DRIVE_BACK_RIGHT = 2;
	public static final int CAN_ID_SPARK_DRIVE_FRONT_LEFT = 1;
	//public static final int CAN_ID_SPARK_DRIVE_BACK_LEFT = 4;
	public static final int CAN_ID_SPARK_SHOOTER = 5;
	public static final int POTENTIOMETER_CHANNEL = 2;
	public static final int SWITCH_CHANNEL = 3;
