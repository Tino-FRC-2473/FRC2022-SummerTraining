...
public final class HardwareMap {
	...
	public static final int CAN_ID_SPARK_DRIVE_BACK_RIGHT = 3;
	public static final int CAN_ID_SPARK_DRIVE_FRONT_LEFT = 2;
	public static final int CAN_ID_SPARK_DRIVE_BACK_LEFT = 4;
	public static final int CAN_ID_LEFT_MOTOR = 5;
	public static final int CAN_ID_RIGHT_MOTOR = 6;
